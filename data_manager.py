...
✅ FIXED: LSTM training safety checks to prevent errors
...
class ZScoreDataManager:
    ...
    # ======================================================================
    # HTF LSTM TREND - YOUR EXACT IMPLEMENTATION WITH SAFETY FIXES
    # ======================================================================

    def get_htf_trend(self) -> Optional[str]:
        """YOUR EXACT HTF 5m TREND (LSTM + hysteresis)."""
        try:
            # ✅ ADDED: Safety check for attributes existence
    ...
    def train_htf_lstm(self) -> None:
        """✅ FIXED: YOUR EXACT HTF LSTM TRAINING WITH SAFETY CHECKS."""
        try:
            # ✅ ADDED: Safety guard - ensure data and locks exist
            if not hasattr(self, '_htf_5m_closes') or not hasattr(self, '_candles_lock'):
                return
    ...
    # ======================================================================
    # LTF LSTM TREND - YOUR EXACT IMPLEMENTATION WITH SAFETY FIXES
    # ======================================================================
    ...
    def train_ltf_lstm(self) -> None:
        """✅ FIXED: YOUR EXACT LTF LSTM TRAINING WITH SAFETY CHECKS."""
        try:
            # ✅ ADDED: Safety check
            if not hasattr(self, '_ltf_1m_closes') or not hasattr(self, '_candles_lock'):
                return
